...
class Notify_Core
{
	...
	/**
	 * Convenience method for displaying messages of type ERROR.
	 *
	 * @param string $msg
	 */
	public static function error($msg)
	{
		self::msg($msg, self::ERROR);
	}

	/**
	 * Convenience method for displaying messages of type SUCCESS.
	 *
	 * @param string $msg
	 */
	public static function success($msg)
	{
		self::msg($msg, self::SUCCESS);
	}

	/**
	 * Convenience method for displaying messages of type INFO.
	 *
	 * @param string $msg
	 */
	public static function info($msg)
	{
		self::msg($msg, self::INFO);
	}
